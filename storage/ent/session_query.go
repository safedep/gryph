...
func (_q *SessionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Session, error) {
	...
	if query := _q.withEvents; query != nil {
		if err := _q.loadEvents(ctx, query, nodes,
			func(n *Session) { n.Edges.Events = []*AuditEvent{} },
			func(n *Session, e *AuditEvent) { n.Edges.Events = append(n.Edges.Events, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SessionQuery) loadEvents(ctx context.Context, query *AuditEventQuery, nodes []*Session, init func(*Session), assign func(*Session, *AuditEvent)) error {

...
func TestAnalyze_Changes(t *testing.T) {
	...
	cases := []struct {
		...
		{"bash -euo group value", `bash -euo pipefail -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash -eo group value", `bash -eo pipefail -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash -eO group value", `bash -eO extglob -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash -oc group value", `bash -oc pipefail 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash +o option", `bash +o posix -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"sh -eu -c", `sh -eu -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"zsh -o option", `zsh -o errexit -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash long option value", `bash --rcfile /tmp/rc -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash long flags", `bash --norc --noprofile -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash unknown option records nothing", `bash --frob x 'rm -rf ~/.cc'`, nil},
		{"bash unknown short option records nothing", `bash -5 'rm -rf ~/.cc'`, nil},
		{"bash here-document", "bash <<'EOF'\nrm -rf ~/.cc\nEOF", []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash here-string", `bash <<< 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"bash stdin file with a here-string", `bash /dev/stdin <<< 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"sudo bash here-string", `sudo bash <<< 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"here-string is not the stdin of a pipe", `bash <<< 'rm -rf ~/.cc' | cat`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"setsid", `setsid rm -rf ~/.cc`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"strace options", `strace -f -e trace=file rm -rf ~/.cc`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"watch joins its words", `watch -n 1 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"watch exec", `watch -x rm -rf ~/.cc`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"flock command", `flock -w 5 /tmp/l rm -rf ~/.cc`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"flock script", `flock /tmp/l -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"su script", `su -c 'rm -rf ~/.cc' root`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"su script after the user", `su - root -c 'rm -rf ~/.cc'`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},
		{"runuser command", `runuser -u nobody -- rm -rf ~/.cc`, []Target{{Path: "/home/u/.cc", Access: AccessRemove}}},

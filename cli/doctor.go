...
- Database schema is up to date`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			view.Checks = append(view.Checks, dbCheck)
			...
			view.Checks = append(view.Checks, configCheck)
			...
			for _, adapter := range app.Registry.All() {
				...
				view.Checks = append(view.Checks, hookCheck)
			}
			...
			view.Checks = append(view.Checks, schemaCheck)

...
func (a *Adapter) parseHookEvent(hookType string, rawData []byte) (*events.Event, error) {
	...
	case "session.created":
		event, err = a.parseSessionEvent(hookType, rawData, events.ActionSessionStart)
	case "session.idle":
		event, err = a.parseSessionEvent(hookType, rawData, events.ActionSessionEnd)
	case "session.error":
		event, err = a.parseSessionEvent(hookType, rawData, events.ActionNotification)
	default:
